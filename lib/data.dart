...
Map Aethon = {
  ...
  'title': 'Aethon',
  'text':
      'The eagle who tormented Prometheus, Aethon, was the child of the monsters Typhon and Echidna. In Greek and Roman mythology there are a number of characters known as Aethon. Most are horses, variously belonging to:Helios, Ares, Hector, Pallas, and Hades.',
  'index': 7
};
Map Afanc = {
  'image': 'blank',
...
Map Amarok = {
  ...
  'title': 'Amarok',
  'text':
      'Amarok or Amaroq is the name of a gigantic grey wolf in Inuit mythology. It is said to hunt down and devour anyone foolish enough to hunt alone at night. Unlike real wolves who hunt in packs, Amarok hunts alone. It is sometimes considered equivalent to the Waheela of cryptozoology.',
  'index': 21
};
Map Amefurikozo = {
  'image': 'blank',
...
Map Anggitay = {
  ...
  'title': 'Anggitay',
  'text':
      'Anggitay are a female race of mythological creatures from the Philippines, with the upper body of a woman and the lower body of a mare. As such, they can be considered the Filipino equivalent of the Greek Centaurides. Additionally, they have also been represented with a single horn on their foreheads, like that of a Unicorn. Some sources have them as the female counterparts of the Tikbalang, and some claim they\'re obsessed with hoarding gold or precious gemstones.',
  'index': 28
};
Map Anubis = {
  'image': 'blank',
...
Map Anzu = {
  ...
  'title': 'Anzû ',
  'text':
      'Anzû, also known as Imdugud, is a lesser divinity or monster in several Mesopotamian religions. He was conceived by the pure waters of the Apsu and the wide Earth, or as son of Siris. Anzû was depicted as a massive bird who can breathe fire and water, although Anzû is alternately depicted as a lion-headed eagle.',
  'index': 30
};
Map Apep_apophis = {
  'image': 'blank',
...
Map Asteriae = {
  ...
  'title': 'Asteriae',
  'text':
      'Asteriae was the Titan goddess of falling stars and perhaps of nighttime divinations such as oneiromancy (by dreams) and astrology (by stars). She was the mother of Hekate (Hecate), goddess of witchcraft, by the Titan Perses. After the fall of the Titans, Zeus chased Asteria across the sky but she escaped him by transforming herself into a quail and leaping into the sea to became the island of Delos. She is probably the same as Brizo, an obscure Delian goddess who delivered prophetic dreams.',
  'index': 40
};
Map Asura = {
  'image': 'blank',
...
Map Axehandle_Hound = {
  ...
  'text':
      'The Axehandle Hound is a fearsome dog originated from Wisconsin and Minnesota, it has a slender body in the shape of a handle of an axe and a head the shape of an axe head. It also has short stubby legs. Despite its dangerously shaped head, the Axehandle Hound was not known to be deadly. However it would pester lumberjacks by stealing any axe handles left unattended and storing them away to be eaten. This nocturnal creature travels from camp to camp searching for its next meal. In Minnesota, there is a canoe-access campground named Ax-Handle Hound after the folklore creature. It can be found on the Little Fork River near Voyageurs National Park and very near the town of Linden Grove.',
  'index': 43
};
Map Azeban = {
  'image': 'blank',
...
Map Bai_Ze = {
  ...
  'title': 'Bai Ze',
  'text':
      'Bai Ze is a Chinese holy beast whose name translates into "White Marsh." There is a Japanese version of this creature that is known as Hakutaku or Kutabe. It is a chimera like creature that looks like a white ox. It has nine eyes, three on its human-like head, and three on the heads that are on each side of its torso. It reaches to the size of a mountain. Basically any mountain. It\'s fricken big. Each head has two horns. It has about 17 mustaches, some "experts" say there could be as many as 33 mustaches, others as few as 14 mustaches. Bai Ze was sometimes described as a mythical creature whose body resembles a hand and whose head is human. They are seen to be signs of extremely good luck, only showing up in countries with good luck. They can speak human languages and are very intelligent. Some even say that they know everything in the world.',
  'index': 48
};
Map Bake_kujira = {
  'image': 'blank',
